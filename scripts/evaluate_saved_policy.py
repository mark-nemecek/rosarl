...
if __name__ == "__main__":
    ...
    for env_id, env_files in run_info.items():
        ...
        print("\n", f"=========== Starting Env f{env_id} with noise level {noise_level}")
        ...
        print("\n", f"=========== Finished Env f{env_id} with noise level {noise_level}")
    ...
    latex_table = generate_latex_table(sorted_results, algo_list, noise_list)
    print("\n", latex_table)
